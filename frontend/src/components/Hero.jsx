  ...
  return (
    <div className="text-white relative">
      <img
        ...
        alt="Hero Background"
        className="w-full rounded-2xl h-[450px] object-center object-cover"
      />

      <div className="flex space-x-2 md:space-x-4 absolute bottom-3 left-4 md:bottom-8 md:left-10 font-medium">
        <button className="flex justify-center items-center bg-white rounded-full hover:bg-gray-400 py-3 px-4 text-[#e50914] cursor-pointer text-sm md:text-base">
          <Bookmark className="mr-1 w-4 h-5 md:w-5 md:h-5" />
          Save for later
        </button>
