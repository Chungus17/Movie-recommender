    ...
    <nav className='bg-black text-gray-200 flex justify-between items-center p-4 h-20 text-sm md:text-[15px] font-medium text-nowrap'>
        ...
        <div className='flex items-center space-x-4 relative'>
            <div className='relative hidden md:inline-flex'>
                <input type="text" placeholder='Search...' className='bg-[#333333] px-4 py-2 rounded-full outline-none min-w-72 pr-10'/>
                <Search className='absolute top-2 right-4 w-5 h-5 cursor-pointer'/>
            </div>
            <button className='bg-[#e50914] px-5 py-2 text-white cursor-pointer rounded-full hover:bg-[#ba0911]'>AI recommender</button>
            <button className='border border-[#333333] py-2 px-4 cursor-pointer rounded-full hover:border-[#334444]'>Sign In</button>
        </div>
    </nav>
  )
}
